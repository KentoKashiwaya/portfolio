  ...
  return (
    <div className="About">
      ...
      <div className="container ab_container">
        <img className="table ab_img sp_only" src={profile} />
        <img className="table ab_img sp_only" src={profile2} />
      </div>
      <div className="container ab_container">
        <img className="table ab_img pc_only" src={profile} />
        <div className="table ab_table">
          <div className="ab_child">
          <h2>柏谷健人(かしわやけんと)</h2>
          <h3><span className="ab_strong">1995年4月17日生まれ(25歳)</span></h3>
          <div className="ab_discription">
